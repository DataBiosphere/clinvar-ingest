...
import org.broadinstitute.monster.clinvar.jadeschema.table.{Variation => JadeVariation, _}
import org.broadinstitute.monster.clinvar.parsers.{VCV, SCV, Variation}
